// Fix: Provide content for the missing icons file to resolve multiple module import errors.
...
export const StudentIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v11.494m-5.747-8.247l11.494 0M4 12.5a8.5 8.5 0 1117 0 8.5 8.5 0 01-17 0z" />
  </svg>
);

export const ParentIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
